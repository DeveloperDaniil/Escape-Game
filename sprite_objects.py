...
class Sprites:
    def __init__(self):
        self.sprite_parameters = {
            ...
            'card': {
                'sprite': pygame.image.load('sprites/card/0.png').convert_alpha(),
                'viewing_angles': None,
                'shift': 0.7,
                'scale': (0.6, 0.6),
                'side': 30,
            ...
            'albert': {
                'sprite': pygame.image.load('sprites/npc/albert/0.png').convert_alpha(),
                'viewing_angles': None,
                'shift': 0.8,
                'scale': (0.4, 0.6),
                'side': 30,
            ...
            'helicopter': {
                'sprite': pygame.image.load('sprites/helicopter/0.png').convert_alpha(),
                'viewing_angles': None,
                'shift': 0.1,
                'scale': (3, 1.2),
                'side': 100,
        ...
        self.list_of_objects = [
            SpriteObject(self.sprite_parameters['card'], (4337.913854156224, 2702.4153354766995)),
            SpriteObject(self.sprite_parameters['door'], (2675.7190451783654, 1349.823243813568)),
            SpriteObject(self.sprite_parameters['albert'], (2400.717321108535, 1349.8687726791059)),
            SpriteObject(self.sprite_parameters['helicopter'], (2226.1533904247317, 1360.0346482999228)),
        ]
...
class SpriteObject:
    ...
    def card_sound(self):
        song = pyglet.media.load('sound/card.mp3')
        song.play()
    ...
    def open_door(self):
        if self.flag == 'door_h':
            ...
            self.y += 50000
            self.x -= 30000
            b = threading.Thread(target=self.card_sound, name='B', daemon=True)
            b.start()
